...
contract StarNotary is ERC721 {
    ...
    string public name = "MorsaStar";
    string public symbol = "UHUH";
        ...
        returns (string memory)
    {
        ...
        require(
            tokenIdToStarInfo[_tokenId].exists,
            "No star was found with that ID"
        );
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(
            ...
            "None of the tokends belong to the sender"
        );
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        // safeTransferFrom is recommened to be sued instead of transferFrom
